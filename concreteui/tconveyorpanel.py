...
class Ui_TConveyorPanel(object):
    def setupUi(self, TConveyorPanel):
        if not TConveyorPanel.objectName():
            TConveyorPanel.setObjectName(u"TConveyorPanel")
        TConveyorPanel.resize(224, 147)
        TConveyorPanel.setStyleSheet(u"QGroupBox\n"
"{\n"
...
"	width: 24px;\n"
"}")
        TConveyorPanel.setAlignment(Qt.AlignCenter)
        self.verticalLayout = QVBoxLayout(TConveyorPanel)
        self.verticalLayout.setSpacing(5)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setSizeConstraint(QLayout.SetFixedSize)
        self.verticalLayout.setContentsMargins(-1, 24, -1, -1)
        self.ctl_group = QWidget(TConveyorPanel)
        ...
        self.more = QCheckBox(TConveyorPanel)
        ...
        self.preferences = QWidget(TConveyorPanel)
        ...
        self.retranslateUi(TConveyorPanel)
        self.more.toggled.connect(self.preferences.setVisible)

        QMetaObject.connectSlotsByName(TConveyorPanel)
    # setupUi

    def retranslateUi(self, TConveyorPanel):
        TConveyorPanel.setWindowTitle(QCoreApplication.translate("TConveyorPanel", u"\u041d\u0430\u043a\u043b\u043e\u043d\u043d\u044b\u0439 \u043a\u043e\u043d\u0432\u0435\u0439\u0435\u0440", None))
        TConveyorPanel.setTitle(QCoreApplication.translate("TConveyorPanel", u"\u0422\u0440\u0430\u043d\u0441\u043f\u043e\u0440\u0442\u043d\u044b\u0439 \u043a\u043e\u043d\u0432\u0435\u0439\u0435\u0440", None))
        self.power.setText(QCoreApplication.translate("TConveyorPanel", u"\u0412\u041a\u041b\u042e\u0427\u0418\u0422\u042c", None))
        self.powered.setText("")
        self.more.setText(QCoreApplication.translate("TConveyorPanel", u"\u041f\u043e\u043a\u0430\u0437\u0430\u0442\u044c", None))
        self.stopT.setSuffix(QCoreApplication.translate("TConveyorPanel", u" \u0441\u0435\u043a", None))
        self.hint_2.setText(QCoreApplication.translate("TConveyorPanel", u"\u0410\u0432\u0442\u043e\u043c\u0430\u0442:", None))
        self.hint_1.setText(QCoreApplication.translate("TConveyorPanel", u"T \u043e\u0442\u043a\u043b\u044e\u0447\u0435\u043d\u0438\u044f:", None))
        self.active.setText("")
    # retranslateUi
...
class Ui_TConveyorPanelEx(object):
    def setupUi(self, TConveyorPanelEx):
        ...
        TConveyorPanelEx.resize(240, 196)
...
"}")
        ...
        self.gridLayout.addWidget(self.hint_2, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.active, 2, 2, 1, 1, Qt.AlignHCenter)
        ...
        self.gridLayout.addWidget(self.hint_3, 3, 0, 1, 1)

        self.reverse = QCheckBox(self.preferences)
        self.reverse.setObjectName(u"reverse")

        self.gridLayout.addWidget(self.reverse, 3, 2, 1, 1, Qt.AlignHCenter)
    ...
    def retranslateUi(self, TConveyorPanelEx):
        TConveyorPanelEx.setWindowTitle(QCoreApplication.translate("TConveyorPanel", u"\u041d\u0430\u043a\u043b\u043e\u043d\u043d\u044b\u0439 \u043a\u043e\u043d\u0432\u0435\u0439\u0435\u0440", None))
        TConveyorPanelEx.setTitle(QCoreApplication.translate("TConveyorPanel", u"\u0422\u0440\u0430\u043d\u0441\u043f\u043e\u0440\u0442\u043d\u044b\u0439 \u043a\u043e\u043d\u0432\u0435\u0439\u0435\u0440", None))
        self.power.setText(QCoreApplication.translate("TConveyorPanel", u"\u0412\u041a\u041b\u042e\u0427\u0418\u0422\u042c", None))
        self.powered.setText("")
        self.more.setText(QCoreApplication.translate("TConveyorPanel", u"\u041f\u043e\u043a\u0430\u0437\u0430\u0442\u044c", None))
        self.hint_1.setText(QCoreApplication.translate("TConveyorPanel", u"T \u043e\u0442\u043a\u043b\u044e\u0447\u0435\u043d\u0438\u044f:", None))
        ...
        self.hint_2.setText(QCoreApplication.translate("TConveyorPanel", u"\u0410\u0432\u0442\u043e\u043c\u0430\u0442:", None))
        self.active.setText("")
        self.hint_3.setText(QCoreApplication.translate("TConveyorPanel", u"\u0420\u0435\u0432\u0435\u0440\u0441", None))
        self.reverse.setText("")
    # retranslateUi

class TConveyorPanel(QGroupBox):
    def __init__(self, *args, **kwargs):
        super(QGroupBox, self).__init__(*args, **kwargs)
        self._ui = Ui_TConveyorPanel()
