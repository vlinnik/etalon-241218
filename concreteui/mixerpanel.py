...
try:
        from AnyQt.QtCore import Q_ENUM as Q_ENUM
except:
...
class __Ui_MixerPanel(object):
    def setupUi(self, MixerPanel):
        if not MixerPanel.objectName():
            MixerPanel.setObjectName(u"MixerPanel")
        MixerPanel.resize(292, 73)
        MixerPanel.setStyleSheet(u"QGroupBox\n"
"{\n"
"	margin-top: 2ex;\n"
"	color: white;\n"
"	font-weight: bold;\n"
...
"}")
        MixerPanel.setAlignment(Qt.AlignCenter)
        self.horizontalLayout = QHBoxLayout(MixerPanel)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.open = QToolButton(MixerPanel)
        ...
        self.close = QToolButton(MixerPanel)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/MixerPanel/open.png", QSize(), QIcon.Normal, QIcon.Off)
        self.nack.setIcon(icon5)
        self.nack.setIconSize(QSize(32, 32))

        self.horizontalLayout.addWidget(self.nack)


        self.retranslateUi(MixerPanel)

        QMetaObject.connectSlotsByName(MixerPanel)
    # setupUi

    def retranslateUi(self, MixerPanel):
        MixerPanel.setWindowTitle(QCoreApplication.translate("MixerPanel", u"MixerPanel", None))
        MixerPanel.setTitle(QCoreApplication.translate("MixerPanel", u"\u0443\u043f\u0440\u0430\u0432\u043b\u0435\u043d\u0438\u0435 \u0437\u0430\u0442\u0432\u043e\u0440\u043e\u043c", None))
...
class MixerPanel(QGroupBox,__Ui_MixerPanel):
        ...
        def __init__(self, *args, **kwargs):
                ...
                self.setupUi(self)
                self.setGateType(GateTypes.Hydraulic)
                
        def setGateType(self,_type: GateTypes):
                self._gateType = _type
                if _type==GateTypes.Pneumatic:
                        self.open.setCheckable(True)
